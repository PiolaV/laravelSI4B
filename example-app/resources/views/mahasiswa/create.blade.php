    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="{{route('mahasiswa.store')}}"> <form class="forms-sample">
                @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="tempat lahir"  value="{{ old('tempat lahir')}}" placeholder="tempat lahir">
                @error('tempat lahir')
                    <span class="text-danger"> {{$message}} </span>
                @enderror
              </div> 
              <div class="form-group">
                ...
                <input type="date" class="form-control" name="tanggal lahir"  value="{{ old('tanggal lahir')}}" placeholder="tanggal lahir">
                @error('tanggal lahir')
                    <span class="text-danger"> {{$message}} </span>
                @enderror
              </div> 
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="url_foto"  value="{{ old('url_foto')}}" placeholder="url_foto">
                @error('url_foto')
                    <span class="text-danger"> {{$message}} </span>
                @enderror
              </div> 
